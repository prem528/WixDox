    ...
    return (
        <section className="w-full px-6 md:px-24 mt-0 flex flex-col md:flex-row items-center justify-center gap-10 pt-10 pb-6 min-h-screen bg-white text-white relative">
            <div className="flex flex-col gap-4 max-w-xl flex-1">
                <h1 className="text-3xl md:text-5xl font-light text-gray-900 animate-fade-in">
                ...
                <div className="flex gap-3 pt-2">
                    <Button className="bg-blue-400 hover:bg-blue-500 cursor-pointer shadow-lg transition-all hover:scale-105 animate-fade-in">Contact Now</Button>
